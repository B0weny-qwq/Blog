...
在工程里，我第一次找到了自我。`APP` 层的联合使用，让我感觉自己像是工程王国里的统治者，掌控着一整套规则。反过来，返校之后再去学课本上的东西，只让我觉得恶心。那些理论知识没有反馈回路，学到的内容放进工程里，很多时候连路边的蚂蚁都不如，至少蚂蚁还真在干活。也是从那时起，我第一次那么清楚地感受到 `CN` 教育体系的问题。
...
对工程的狂热、对技术的野心，让我身上慢慢有了 `Larry Wall` 说的那种“傲慢”。但我到现在依旧觉得，这是对的。如果连这点技术认同感都没有，我大概也坚持不到现在。说白了，我就是看不上那种明明没产出，却还要靠一套评价体系自我感动的东西。哈哈哈。
...
嵌入式架构、系统开发和硬件这些工作，让我第一次感受到初创公司的魅力：有话语权，能做研发，而不是单纯去打工、做那种谁来都能替代的重复劳动。
...
也是在这一阶段，`agent` 的介入逐渐成熟。长时间使用之后，我对这个时代里“人”到底该做什么，有了更清楚的判断。简单、重复的工作交给 `agent`、脚本和下手；自己的精力放在高层决策、需求对接和技术方案落地上。这些才是别人做不到、只有我才能做的活。还把自己绑在低级重复劳动上，只能说明对工具没有理解，对自己也没有要求。
...
作为“著名本科进化论”提出者，我现在越来越觉得，进化不只是技术上的长进，更是思维方式和工作流的变化。拥抱现代、接受革新，多交流，别闭门造车，这些才是进化的关键。
