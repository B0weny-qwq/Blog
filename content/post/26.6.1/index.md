...
我最近越来越明显地感觉到，很多人学嵌入式，最大的问题不是不努力，而是一开始就被带进了一条很旧的路径里。

最典型的情况就是：一入门就去 `B` 站找视频。

这件事本身当然没问题。视频对初学者很友好，能让人快速看到一个东西怎么跑起来，也能降低刚接触硬件、寄存器、外设、开发板时的恐惧感。问题在于，很多人找视频的时候根本不看视频年限，也不看它适合什么基础阶段，更不会判断这套教程背后的工程方式是不是已经落后。

最后就很容易形成路径依赖。

别人用什么软件，他就用什么软件；别人怎么建工程，他就怎么建工程；别人怎么点 `Keil`，他就怎么点 `Keil`；别人怎么复制例程，他就怎么复制例程。短期看起来是在学习，实际上很可能是在把自己训练成旧流程的执行者。

更严重的是，这种路径依赖会让人和现代开发方式完全脱节。

## 教程会教你怎么用，但很少教你怎么看工程

很多教学视频最大的问题，是它只会告诉你“怎么用”。

怎么新建工程，怎么点按钮，怎么配置外设，怎么把例程跑起来，怎么照着老师的步骤把灯点亮、把串口跑通、把屏幕刷出来。

这些东西对入门有价值，但它们远远不够。

真正决定工程能力的，不是你会不会照着教程把某个外设跑起来，而是你能不能理解一个项目为什么要这样组织：目录为什么这么分，驱动为什么这样抽象，接口为什么这样暴露，模块之间为什么不能乱依赖，配置和实现为什么要分开，构建系统为什么要可复现。
...
你会很熟悉某个视频里的步骤，但离开那个模板就不会做；你能改一个例程，但不知道怎么设计一个模块；你能把功能堆上去，但不知道怎么控制复杂度。最后写出来的东西很容易变成一坨能跑但不能碰的代码。
